export const questions = [
    ...
    { id: 'i4', type: '평화주의자', question: '나는 다 중요해 보여서 우선순위를 정하는 것이 어렵다' },
    ...
    { id: 'e4', type: '탐구자', question: '화가 나도 감정을 배제하고 객관적으로 바라본다' },
    ...
    { id: 'h4', type: '지도자', question: '나는 일을 단계적으로 하기보다는 속전속결로 끝낸다' },
    ...
    { id: 'c4', type: '성취자', question: '나는 남과 비교를 잘하고 경쟁심이 강한 편이다' },
